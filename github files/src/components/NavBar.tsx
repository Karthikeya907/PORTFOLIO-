      ...
      >
        ...
        <div className="hidden md:flex items-center gap-8 absolute right-6 lg:left-auto lg:right-8">
          ...
          <button
            ...
            className="p-2 border border-cyan-500/40 hover:border-cyan-400 bg-black/40 rounded-full text-cyan-400 hover:text-white hover:shadow-[0_0_15px_rgba(0,240,255,0.4)] transition-all duration-300 cursor-pointer"
          >
      ...
      <div className="md:hidden w-full px-6 mt-2 overflow-x-auto hide-scrollbar">
        <div className="flex items-center justify-start gap-5 pb-2 w-max mx-auto">
          ...
          <button
            onClick={toggleSound}
            title={muted ? "Unmute Audio" : "Mute Audio"}
            className="p-1 border border-cyan-500/50 rounded-full text-cyan-400 cursor-pointer"
          >
