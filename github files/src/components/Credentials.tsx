...
export const Credentials: React.FC = () => {
  ...
  const handleViewCert = (cert: any) => {
    const imgUrl = cert.certificateFile || cert.imageUrl || cert.url || (cert.title ? `/cert_${cert.id || '1'}.png` : null);
    if (imgUrl) {
  ...
  return (
    <section id="credentials" className="py-14 sm:py-16 relative bg-transparent">
